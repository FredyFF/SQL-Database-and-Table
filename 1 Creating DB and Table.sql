...
/*
	...
	DDL (Data Definition Language) adalah perintah-perintah pada SQL yang digunakan untuk membuat atau merubah struktur dari database dan table.
*/

/*CREATE DATABASE: adalah function yang digunakan untuk menciptakan database yang baru.*/
...
PRINT @global;
BEGIN
	DECLARE @name AS VARCHAR(50) = 'Berta';
...
/*
	StudentNumber adalah PRIMARY KEY (PK) dari Student bersifat unik dan tidak ada duplikatnya. Tetapi lebih lagi digunakan sebagai identitas utama dari 
	satu row.
